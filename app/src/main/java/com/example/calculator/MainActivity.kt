...
class MainActivity : AppCompatActivity() {
    ...
    fun buttonClicked(v: View){
        when(v.id){
            ...
            R.id.buttonModolo -> operatorButtonClicked("%")
        }
    ...
    private fun numberButtonClicked(number :String){
        ...
        //TODO resultTextView 실시간으로 계산 결과에 넣어야 하는 기능
    }
    ...
    private fun operatorButtonClicked(operator : String){
        ...
        when{
            isOperator -> {
                ...
                expressionTextView.text = text.dropLast(1) + operator    //맨끝에서부터 한자리만 지워줌  코틀린
